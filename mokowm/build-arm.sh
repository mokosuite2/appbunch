...
-DPACKAGE_BUGREPORT=\"daniele.athome@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"mokosuite\" $3 $EXTRA_CFLAGS -DOPENMOKO \
...
compile_file wm.c build/wm.o
compile_file client.c build/client.o
compile_file dock_client.c build/dock_client.o
compile_file splash_client.c build/splash_client.o
compile_file dialog_client.c build/dialog_client.o
compile_file desktop_client.c build/desktop_client.o
compile_file input_client.c build/input_client.o
compile_file input.c build/input.o
...
-L$STAGE/usr/lib \
-L$STAGE/lib \
-lecore -lecore_x -leet -lgobject-2.0 -lrt -lglib-2.0 -lX11 -lXtst -ledje -lfakekey -levas -lecore_evas
