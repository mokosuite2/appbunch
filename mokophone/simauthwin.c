...
SimAuthWin* sim_auth_win_new(SIMAuthStatus type)
{
    ...
    mokowin_create_layout(MOKO_WIN(s), MOKOSUITE_DATADIR "theme.edj", "mokosuite/phone/sim_auth");
    ...
    elm_layout_file_set(s->keypad, MOKOSUITE_DATADIR "theme.edj", "mokosuite/common/keypad");
