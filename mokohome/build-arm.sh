...
-DPACKAGE_BUGREPORT=\"daniele.athome@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"mokosuite\" -DOPENMOKO $3 \
...
compile_file launchers.c build/launchers.o
compile_file widgets.c build/widgets.o
compile_file desktop.c build/desktop.o
